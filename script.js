...
function validateGuess(guess) {
    ...
    if (!words.includes(guess)) {
        ...
        setTimeout(() => {
            showTemporaryMessage("Mot non valide. Réessayez !");
            clearCurrentRow();
    ...
    setTimeout(() => {
        if (guess === secretWord) {
            ...
            setTimeout(() => {
                showTemporaryMessage("Félicitations ! Vous avez trouvé le mot !", 3000);
            ...
            showTemporaryMessage(`Vous avez perdu ! Le mot était : ${secretWord.toUpperCase()}`, 3000);
